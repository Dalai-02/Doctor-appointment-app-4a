...
@php
    ...
    $links = [
        ...
        ], // <-- MISSING COMMA HERE (after the first array element)
        [
            'header'=> 'Hospital'
        ], // <-- MISSING COMMA HERE (after the second array element)
        [
              'name' => 'Dashboard',
              'icon'=>'fa-solid fa-gauge',
              'href'=>route('admin.dashboard'),
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                @else
                <a href="{{$link['href']}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{$link['active'] ? 'bg-gray-400' : ''}}">

                    <span class="w-6 h-6 inline-flex justify-center items-center text-gray-200">
                                            <i class="{{ $link['icon'] }}"></i>
                    </span>
