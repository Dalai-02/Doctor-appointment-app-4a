<x-admin-layout 
    title="Editar Aseguradora | MediCitas"
    :breadcrumbs="[
    ...
    <div class="p-4 mt-4">
        <div class="bg-white rounded-lg shadow-md p-6 dark:bg-gray-800">
            <h2 class="text-xl font-semibold text-gray-900 mb-2 dark:text-white">Editar Aseguradora</h2>
            <p class="text-gray-600 text-sm mb-6 dark:text-gray-400">Modifique los datos de la aseguradora o convenio médico.</p>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" 
                               name="nombre_empresa" 
                               id="nombre_empresa" 
                               value="{{ old('nombre_empresa', $insurance->nombre_empresa) }}"
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('telefono_contacto', $insurance->telefono_contacto) }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <textarea name="notas_adicionales" 
                                  ...
                                  rows="6"
                                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                  placeholder="Información adicional sobre el convenio, cobertura, etc.">{{ old('notas_adicionales', $insurance->notas_adicionales) }}</textarea>
                    ...
                    <div class="flex justify-end space-x-3 pt-4">
                        ...
                        <button type="submit" 
                            ...
                            <i class="fa-solid fa-floppy-disk mr-2"></i>Actualizar Aseguradora
                        </button>
                    </div>
                </div>
            </form>
